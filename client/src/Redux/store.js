...
const rootReducer = combineReducers({
  ...
  createService: services.createServiceReducer,
  updateService: services.updateServiceReducer,
  deleteService: services.deleteServiceReducer,
  deleteAllService: services.deleteAllServiceReducer,
});
