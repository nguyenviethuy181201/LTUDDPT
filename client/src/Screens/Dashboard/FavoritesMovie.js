...
const FavoritesMovie = () => {
  ...
  const deleteAMovieHandler = (movieId) => {
    window.confirm('Are you sure you want to delete') &&
      dispatch(deleteAFavoritesMoviesAction(movieId));
  };
    ...
    <SlideBar>
      <div className="flex flex-col gap-6">
        ...
        {isLoading ? (
          ...
          <Table data={likedMovies} admin={false} onDeleteHandler={deleteAMovieHandler}/>
        ) : (
