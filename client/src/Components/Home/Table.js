        ...
        {admin ? (
          <div className='transform  absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] flex gap-2'>
            ...
            <button
              ...
              className="bg-subMain text-white rounded group flex-colo w-6 h-6 hover:bg-transparent hover:border hover:border-subMain"
            >
          ...
          <div className='transform  absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] flex gap-2'>
            ...
            <Link
              to={`/movie/${movie?._id}`}
              className="bg-subMain group text-white rounded flex-colo  w-6 h-6  hover:bg-transparent hover:border-subMain border border-transparent"
            >
              <GoEye className='group-hover:text-red-500'/>
            </Link>
            <button
              onClick={() => onDeleteHandler(movie?._id)}
              className="bg-subMain group text-white rounded border border-subMain flex-colo w-6 h-6 hover:bg-transparent hover:border horver:border-subMain "
            >
              <MdDelete className='group-hover:text-subMain' />
            </button>
